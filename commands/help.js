...
module.exports = class HelpCommand extends BaseCommand {
    ...
    async run(message, args = [], flags = []) {
        ...
        if (!command) {
            // TODO: Rework this section to use new permissions handling
            ...
            let embed = new RichEmbed()
                ...
                .setDescription(
                    stripIndents`${oneLine`Pokemon URPG's Discord game and information bot.
                ...
                **Available Commands**`
                ...
                .setFooter(
                    'Most commands have more help available via !help [command] or !command -h'
                )
