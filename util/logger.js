    ...
    if (!logger) {
        logger = Object.assign(
            createLogger({
                ...
                newStarter: async function (message, trainer, starter) {
                ...
                reflog: async function (message, log) {
                ...
                messageDelete: async function (message, auditLog) {
                ...
                prune: async function (message, numDeleted) {
                ...
                guildMemberRemove: async function (member, auditLog) {
